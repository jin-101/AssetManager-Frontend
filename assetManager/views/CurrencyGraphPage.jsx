...
function CurrencyGraphPage(){
    ...
    return (
    <ScrollView>
        <Text ml="3" fontWeight="bold">CNH</Text> 
        <LineChart
                data={{
                ...
                xLabelsOffset={1}
            />
        <Text ml="3" fontWeight="bold">USD</Text> 
        <LineChart
                data={{
                labels: ["2018", "2019", "2020", "2021", "2022", "2023"],
                datasets: [
                ...
                xLabelsOffset={1}
            />
        <Text ml="3" fontWeight="bold">JPY</Text> 
        <LineChart
                data={{
                labels: ["2018", "2019", "2020", "2021", "2022", "2023"],
                datasets: [
                ...
                xLabelsOffset={1}
            /> 
        <Text ml="3" fontWeight="bold">GBP</Text> 
        <LineChart
                data={{
                labels: ["2018", "2019", "2020", "2021", "2022", "2023"],
                datasets: [
                ...
                xLabelsOffset={1}
            />
        <Text ml="3" fontWeight="bold">EUR</Text> 
        <LineChart
                data={{
                labels: ["2018", "2019", "2020", "2021", "2022", "2023"],
                datasets: [
